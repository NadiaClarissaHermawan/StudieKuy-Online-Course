    ...
    <div id="main">
        ...
        <div class="contentLogin">
			...
			<div class="rowLogin tulisanCoklat">
				...
				<span style="width: 7px;"  class="hurufSedang">:</span>
                <input type="password" class="kotakInput hurufSedang" id="uemail" name="uemail" placeholder="Enter e-mail"/>
            </div>
			<div class="rowLogin tulisanCoklat" style="margin-bottom: 30px;">
				<label for="uphone" class="txt hurufSedang">Phone</label>
				<span style="width: 7px;"  class="hurufSedang">:</span>
                <input type="password" class="kotakInput hurufSedang" id="uphone" name="uphone" placeholder="Enter phone number"/>
            </div>
            <div class="rowLogin tulisanCoklat" style="margin-bottom: 30px;">
				<a href="index" style="text-decoration: none;"><button type="submit" class="button link tulisanCoklat">Register</button></a>
            </div>
        </div>
    </div>
</body>