...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="view/layout/style/courseInfo.css"/>
    </head>
    <body>
        <div class="header">
        ...
        <div class="nav">
            ...
            <a href="bidangCourse?bidang=<?php echo $namaBidang?>" class="menuNav"><?php echo $namaBidang?> /</a>
            <a href="" class="menuNavNow"><?php echo $namaCourse?> /</a>
